...
void Gemm_MRxNRKernel(int k, double *A, int ldA, double *B, int ldB, double *C, int ldC)
{
    ...
    __m256d gamma_45_0 = _mm256_loadu_pd(&gamma(0, 4));
    __m256d gamma_45_1 = _mm256_loadu_pd(&gamma(0, 5));
    ...
    for (int p = 0; p < k; p++)
    {
        ...
        gamma_45_0 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_45_0);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 5));
        gamma_45_1 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_45_1);
    }
    ...
    _mm256_storeu_pd(&gamma(0, 4), gamma_45_0);
    _mm256_storeu_pd(&gamma(0, 5), gamma_45_1);
}

...
void Gemm_MRxNRKernel(int k, double *A, int ldA, double *B, int ldB, double *C, int ldC)
{
    ...
    for (int p = 0; p < k; p++)
    {
        ...
        gamma_4567_0 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_4567_0);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 5));
        gamma_4567_1 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_4567_1);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 6));
        gamma_4567_2 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_4567_2);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 7));
        gamma_4567_3 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_4567_3);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 8));
        gamma_891011_0 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_891011_0);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 9));
        gamma_891011_1 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_891011_1);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 10));
        gamma_891011_2 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_891011_2);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 11));
        gamma_891011_3 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_891011_3);
    }
    ...
    _mm256_storeu_pd(&gamma(0, 4), gamma_4567_0);
    _mm256_storeu_pd(&gamma(0, 5), gamma_4567_1);
    _mm256_storeu_pd(&gamma(0, 6), gamma_4567_2);
    _mm256_storeu_pd(&gamma(0, 7), gamma_4567_3);
    _mm256_storeu_pd(&gamma(0, 8), gamma_891011_0);
    _mm256_storeu_pd(&gamma(0, 9), gamma_891011_1);
    _mm256_storeu_pd(&gamma(0, 10), gamma_891011_2);
    _mm256_storeu_pd(&gamma(0, 11), gamma_891011_3);
}

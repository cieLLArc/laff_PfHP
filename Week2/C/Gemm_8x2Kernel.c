...
void Gemm_MRxNRKernel(int k, double *A, int ldA, double *B, int ldB, double *C, int ldC)
{
    ...
    __m256d gamma_0123_2 = _mm256_loadu_pd(&gamma(0, 1));
    __m256d gamma_0123_1 = _mm256_loadu_pd(&gamma(4, 0));
    __m256d gamma_0123_3 = _mm256_loadu_pd(&gamma(4, 1));
    ...
    for (int p = 0; p < k; p++)
    {
        ...
        gamma_0123_1 = _mm256_fmadd_pd(alpha_4567_p, beta_p_j, gamma_0123_1);

        beta_p_j = _mm256_broadcast_sd(&beta(p, 1));
        gamma_0123_2 = _mm256_fmadd_pd(alpha_0123_p, beta_p_j, gamma_0123_2);
        gamma_0123_3 = _mm256_fmadd_pd(alpha_4567_p, beta_p_j, gamma_0123_3);
    }

    /* Store the updated results */
    _mm256_storeu_pd(&gamma(0, 0), gamma_0123_0);
    _mm256_storeu_pd(&gamma(0, 1), gamma_0123_2);
    _mm256_storeu_pd(&gamma(4, 0), gamma_0123_1);
    _mm256_storeu_pd(&gamma(4, 1), gamma_0123_3);
}

...
void Gemm_MRxNRKernel(int k, double *A, int ldA, double *B, int ldB, double *C, int ldC)
{
    ...
    __m256d gamma_0123_2 = _mm256_loadu_pd(&gamma(8, 0));
    ...
    for (int p = 0; p < k; p++)
    {
        ...
        gamma_0123_2 = _mm256_fmadd_pd(alpha_891011_p, beta_p_j, gamma_0123_2);
    }

    /* Store the updated results */
    _mm256_storeu_pd(&gamma(0, 0), gamma_0123_0);
    _mm256_storeu_pd(&gamma(4, 0), gamma_0123_1);
    _mm256_storeu_pd(&gamma(8, 0), gamma_0123_2);
}
